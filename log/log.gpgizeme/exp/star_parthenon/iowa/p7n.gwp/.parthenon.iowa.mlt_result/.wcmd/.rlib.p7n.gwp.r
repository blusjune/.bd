p7n_gwp_polygon <- function (df, axistype = 0, seg = 4, pty = 16, pcol = 1:8, plty = 1:6, 
    ...
    caxislabels = NULL, paxislabels = NULL) 
{
    ...
    plot(c(-1.2, 1.2), c(-1.2, 1.2), type = "n", frame.plot = FALSE, axes = FALSE, xlab = "", ylab = "", main = title, asp = 1)
