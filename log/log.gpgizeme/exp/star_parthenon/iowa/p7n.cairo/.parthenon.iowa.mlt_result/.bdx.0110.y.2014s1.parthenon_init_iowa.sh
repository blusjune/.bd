...
_wcmd_dir=".wcmd";
_wcmd_files=$(cd $_wcmd_dir; ls -1 .bdx.* .bpy.* .rcmd.*)
#_wcmd_files="
#.bdx.0210.y.2014s1.mlt_L3_db_01.sh
#.bpy.iowa.2014s1.mlt_L3_db_01.print_diff_data.py
#.rcmd.iowa.2014s1.mlt_L3_db_01.read_data_and_plot.r
#";
