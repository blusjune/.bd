...
p7n_plot_fiotest_result(arg_y=d$bandwidth, arg_x=xvec, title="bandwidth(kBps)", arg_ymax=923583);
p7n_plot_fiotest_result(arg_y=d$iops, arg_x=xvec, title="IOPS", arg_ymax=6745);
