...
_target_nvme_partition="nvme0n1p1";
...
_test_name="p7n.tg${_TG}_ty${_TY}_qd${_QD}_nj${_NJ}_bs${_BS}";
...
# $_tstamp
_test_param_id="$_test_name";
_test_param_seq="1_of_11";         # 1,2,3,4,5,6,12,24,48,96,192
_test_param_name="TG";
_test_param_val="$_TG";
...
_fio_result_out_file="${_test_result_dir}/fio.$(..ts).${_test_name}.out";
